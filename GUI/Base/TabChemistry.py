...
class Ui_TabChemistry(object):
    def setupUi(self, TabChemistry):
        ...
        self.lbl_ca_min = QLabel(self.group_results)
        self.lbl_ca_min.setObjectName(u"lbl_ca_min")

        self.horizontalLayout_7.addWidget(self.lbl_ca_min)

        self.lbl_ca_max = QLabel(self.group_results)
        self.lbl_ca_max.setObjectName(u"lbl_ca_max")
        self.lbl_ca_max.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_7.addWidget(self.lbl_ca_max)
        ...
        self.lbl_mg_min = QLabel(self.group_results)
        self.lbl_mg_min.setObjectName(u"lbl_mg_min")

        self.horizontalLayout_6.addWidget(self.lbl_mg_min)

        self.lbl_mg_max = QLabel(self.group_results)
        self.lbl_mg_max.setObjectName(u"lbl_mg_max")
        self.lbl_mg_max.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_6.addWidget(self.lbl_mg_max)
        ...
        self.lbl_na_min = QLabel(self.group_results)
        self.lbl_na_min.setObjectName(u"lbl_na_min")

        self.horizontalLayout_5.addWidget(self.lbl_na_min)

        self.lbl_na_max = QLabel(self.group_results)
        self.lbl_na_max.setObjectName(u"lbl_na_max")
        self.lbl_na_max.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_5.addWidget(self.lbl_na_max)
        ...
        self.lbl_cl_min = QLabel(self.group_results)
        self.lbl_cl_min.setObjectName(u"lbl_cl_min")

        self.horizontalLayout_4.addWidget(self.lbl_cl_min)

        self.lbl_cl_max = QLabel(self.group_results)
        self.lbl_cl_max.setObjectName(u"lbl_cl_max")
        self.lbl_cl_max.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_4.addWidget(self.lbl_cl_max)


        self.gridLayout_2.addLayout(self.horizontalLayout_4, 6, 4, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_3, 6, 5, 1, 1)
        ...
        self.horizontalLayout_2.addWidget(self.lbl_hco3_min)
        ...
        self.horizontalLayout_2.addWidget(self.lbl_hco3_min_2)

        self.lbl_hco3_min_3 = QLabel(self.group_results)
        self.lbl_hco3_min_3.setObjectName(u"lbl_hco3_min_3")
        sizePolicy1.setHeightForWidth(self.lbl_hco3_min_3.sizePolicy().hasHeightForWidth())
        self.lbl_hco3_min_3.setSizePolicy(sizePolicy1)
        self.lbl_hco3_min_3.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_2.addWidget(self.lbl_hco3_min_3)

        self.lbl_hc03_max = QLabel(self.group_results)
        self.lbl_hc03_max.setObjectName(u"lbl_hc03_max")
        sizePolicy.setHeightForWidth(self.lbl_hc03_max.sizePolicy().hasHeightForWidth())
        self.lbl_hc03_max.setSizePolicy(sizePolicy)
        self.lbl_hc03_max.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_2.addWidget(self.lbl_hc03_max)


        self.gridLayout_2.addLayout(self.horizontalLayout_2, 6, 6, 1, 1)
...
"150-250 ppm for dark, roasted malt beers", None))
#endif // QT_CONFIG(tooltip)
        self.lbl_ca_min.setText(QCoreApplication.translate("TabChemistry", u"50", None))
        self.lbl_ca_max.setText(QCoreApplication.translate("TabChemistry", u"150", None))
        self.lbl_mg_min.setText(QCoreApplication.translate("TabChemistry", u"10", None))
        self.lbl_mg_max.setText(QCoreApplication.translate("TabChemistry", u"30", None))
        self.lbl_na_min.setText(QCoreApplication.translate("TabChemistry", u"0", None))
        self.lbl_na_max.setText(QCoreApplication.translate("TabChemistry", u"150", None))
        self.lbl_cl_min.setText(QCoreApplication.translate("TabChemistry", u"0", None))
        ...
        self.lbl_hc03_max.setText(QCoreApplication.translate("TabChemistry", u"250", None))
